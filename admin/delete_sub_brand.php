...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql_get_brand = "SELECT brand_id FROM sub_brands WHERE id = " . mysqli_real_escape_string($conn, $id);
    ...
    $sql_get_logo = "SELECT logo FROM sub_brands WHERE id = " . mysqli_real_escape_string($conn, $id);
    ...
    $sql = "DELETE FROM sub_brands WHERE id = " . mysqli_real_escape_string($conn, $id);
